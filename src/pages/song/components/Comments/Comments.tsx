...
const Comments: React.FC = () => {
  ...
  const {
    ...
    commentSongPending,
    commentSongFulfilled,
    commentSongRejected,
    commentSongErrorMessage,
    ...
    <div className={styles.commentsContainer}>
      ...
      {commentsFulfilled && comments && (
        <>
          ...
          {commentSongRejected && (
            <Message>
              {t(commentSongErrorMessage ?? "An error occured")}
            </Message>
          )}
          <div className={styles.leaveCommentContainer}>
            ...
            >
              {commentSongPending ? <Loading size="small" /> : t("Submit")}
            </button>
          </div>
        </>
      )}
