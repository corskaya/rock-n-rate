...
const Comments: React.FC = () => {
  ...
  const {
    ...
    commentAlbumPending,
    commentAlbumFulfilled,
    commentAlbumRejected,
    commentAlbumErrorMessage,
    ...
    <div className={styles.commentsContainer}>
      ...
      {commentsFulfilled && comments && (
        <>
          ...
          {commentAlbumRejected && (
            <Message>
              {t(commentAlbumErrorMessage ?? "An error occurred")}
            </Message>
          )}
          <div className={styles.leaveCommentContainer}>
            ...
            >
              {commentAlbumPending ? <Loading size="small" /> : t("Submit")}
            </button>
          </div>
        </>
      )}
      {commentsRejected && <Message>{t(commentsErrorMessage ?? "An error occurred")}</Message>}
    </div>
  );
};
